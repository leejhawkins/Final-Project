        ...
        <div className="row workout-row" key={props.workout._id}>
            ...
            <Col size="md-6">
                ...
                {props.workout.scores.map(score =>
                    <div>
                        {score.userName === props.user.userName && props.workout.workoutType === "For Time" ? (
                            <Row>
                                <Col size="md-6"><p>Time:{Math.floor(score.score / 60)}:{(score.score % 60) < 10 ? "0" + score.score % 60 : score.score % 60}</p>
                                </Col>
                                <Col size="md-6">   <DeleteBtn onClick={() => props.deleteWorkout(props.workout._id, props.workout.createdBy, score._id)} workout="Time">
                        ...
                        {score.userName === props.user.userName && props.workout.workoutType === "AMRAP" ? (
                            <Row>
                                <Col size="md-6">
                                    <p>Score: {Math.floor(score.score / props.getRoundLength(props.workout.movements))} Rounds + {score.score % props.getRoundLength(props.workout.movements)} Reps</p>
                                </Col>
                                <Col size="md-6">
